...
import ru.ryakovlev.jellypairs.utils.ItemClickSupport;
...
public class ThemeSelectFragment extends Fragment {
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
		View view = LayoutInflater.from(Shared.context).inflate(ru.ryakovlev.jellypairs.R.layout.theme_select_fragment, container, false);

		RecyclerView themeList = (RecyclerView) view.findViewById(ru.ryakovlev.jellypairs.R.id.themeList);
	...
	public static class ThemeAdapter extends RecyclerView.Adapter<ThemeAdapter.ViewHolder> {
		...
		public ThemeAdapter.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
			...
			return new ViewHolder(inflater.inflate(ru.ryakovlev.jellypairs.R.layout.theme_item, parent, false));
		...
		static class ViewHolder extends RecyclerView.ViewHolder {
			...
			ViewHolder(View view) {
				super(view);
				themeLogo = (ImageView) view.findViewById(ru.ryakovlev.jellypairs.R.id.theme_logo);
				themeContainer = (RelativeLayout) view.findViewById(ru.ryakovlev.jellypairs.R.id.theme_container);
				name = (TextView) view.findViewById(ru.ryakovlev.jellypairs.R.id.name);
