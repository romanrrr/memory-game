...
import ru.ryakovlev.jellypairs.common.Memory;
...
import ru.ryakovlev.jellypairs.ui.DifficultyView;

public class DifficultySelectFragment extends Fragment {

    @Override
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        View view = LayoutInflater.from(Shared.context).inflate(ru.ryakovlev.jellypairs.R.layout.difficulty_select_fragment, container, false);
        Theme theme = Shared.engine.getSelectedTheme();

        DifficultyView difficulty1 = (DifficultyView) view.findViewById(ru.ryakovlev.jellypairs.R.id.select_difficulty_1);
        difficulty1.setDifficulty(1, Memory.getHighStars(theme.id, 1));
        setOnClick(difficulty1, 1);

        DifficultyView difficulty2 = (DifficultyView) view.findViewById(ru.ryakovlev.jellypairs.R.id.select_difficulty_2);
        difficulty2.setDifficulty(2, Memory.getHighStars(theme.id, 2));
        setOnClick(difficulty2, 2);

        DifficultyView difficulty3 = (DifficultyView) view.findViewById(ru.ryakovlev.jellypairs.R.id.select_difficulty_3);
        difficulty3.setDifficulty(3, Memory.getHighStars(theme.id, 3));
        setOnClick(difficulty3, 3);

        DifficultyView difficulty4 = (DifficultyView) view.findViewById(ru.ryakovlev.jellypairs.R.id.select_difficulty_4);
        difficulty4.setDifficulty(4, Memory.getHighStars(theme.id, 4));
        setOnClick(difficulty4, 4);

        DifficultyView difficulty5 = (DifficultyView) view.findViewById(ru.ryakovlev.jellypairs.R.id.select_difficulty_5);
        difficulty5.setDifficulty(5, Memory.getHighStars(theme.id, 5));
        setOnClick(difficulty5, 5);

        DifficultyView difficulty6 = (DifficultyView) view.findViewById(ru.ryakovlev.jellypairs.R.id.select_difficulty_6);
        ...
        TextView text1 = (TextView) view.findViewById(ru.ryakovlev.jellypairs.R.id.time_difficulty_1);
        ...
        TextView text2 = (TextView) view.findViewById(ru.ryakovlev.jellypairs.R.id.time_difficulty_2);
        ...
        TextView text3 = (TextView) view.findViewById(ru.ryakovlev.jellypairs.R.id.time_difficulty_3);
        ...
        TextView text4 = (TextView) view.findViewById(ru.ryakovlev.jellypairs.R.id.time_difficulty_4);
        ...
        TextView text5 = (TextView) view.findViewById(ru.ryakovlev.jellypairs.R.id.time_difficulty_5);
        ...
        TextView text6 = (TextView) view.findViewById(ru.ryakovlev.jellypairs.R.id.time_difficulty_6);
