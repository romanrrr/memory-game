...
public class TileView extends FrameLayout {
	...
	public static TileView fromXml(Context context, ViewGroup parent) {
		return (TileView) LayoutInflater.from(context).inflate(ru.ryakovlev.jellypairs.R.layout.tile_view, parent, false);
	}

	@Override
	protected void onFinishInflate() {
		super.onFinishInflate();
		mTopImage = (RelativeLayout) findViewById(ru.ryakovlev.jellypairs.R.id.image_top);
		tileFront = (LinearLayout) findViewById(ru.ryakovlev.jellypairs.R.id.tile_front);
		mTileImage = (ImageView) findViewById(ru.ryakovlev.jellypairs.R.id.image);
	}
