...
import ru.ryakovlev.jellypairs.model.BoardArrangment;
import ru.ryakovlev.jellypairs.model.BoardConfiguration;
...
public class BoardView extends LinearLayout {
	...
	public BoardView(Context context, AttributeSet attributeSet) {
		...
		int margin = getResources().getDimensionPixelSize(ru.ryakovlev.jellypairs.R.dimen.margine_top);
		int padding = getResources().getDimensionPixelSize(ru.ryakovlev.jellypairs.R.dimen.board_padding);
		mScreenHeight = getResources().getDisplayMetrics().heightPixels - margin - padding*2 - Utils.px(50);
	...
	public static BoardView fromXml(Context context, ViewGroup parent) {
		return (BoardView) LayoutInflater.from(context).inflate(ru.ryakovlev.jellypairs.R.layout.board_view, parent, false);
	}
	...
	public void setBoard(Game game) {
		...
		int singleMargin = getResources().getDimensionPixelSize(ru.ryakovlev.jellypairs.R.dimen.card_margin);
