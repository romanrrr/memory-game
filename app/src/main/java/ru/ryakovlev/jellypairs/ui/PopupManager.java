...
public class PopupManager {
	...
	public static void showPopupSettings() {
		RelativeLayout popupContainer = (RelativeLayout) Shared.activity.findViewById(ru.ryakovlev.jellypairs.R.id.popup_container);
		...
		int width = Shared.context.getResources().getDimensionPixelSize(ru.ryakovlev.jellypairs.R.dimen.popup_settings_width);
		int height = Shared.context.getResources().getDimensionPixelSize(ru.ryakovlev.jellypairs.R.dimen.popup_settings_height);
	...
	public static void showPopupWon(GameState gameState) {
		...
		int width = Shared.context.getResources().getDimensionPixelSize(ru.ryakovlev.jellypairs.R.dimen.popup_won_width);
		int height = Shared.context.getResources().getDimensionPixelSize(ru.ryakovlev.jellypairs.R.dimen.popup_won_height);
		RelativeLayout.LayoutParams params = new RelativeLayout.LayoutParams(width, height);
		params.addRule(RelativeLayout.CENTER_IN_PARENT);
	...
	public static void closePopup() {
		final RelativeLayout popupContainer = (RelativeLayout) Shared.activity.findViewById(ru.ryakovlev.jellypairs.R.id.popup_container);
