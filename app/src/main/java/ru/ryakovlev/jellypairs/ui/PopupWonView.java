...
public class PopupWonView extends RelativeLayout {
	...
	public PopupWonView(Context context, AttributeSet attrs) {
		super(context, attrs);
		LayoutInflater.from(context).inflate(ru.ryakovlev.jellypairs.R.layout.popup_won_view, this, true);
		mTime = (TextView) findViewById(ru.ryakovlev.jellypairs.R.id.time_bar_text);
		mScore = (TextView) findViewById(ru.ryakovlev.jellypairs.R.id.score_bar_text);
		mStar1 = (ImageView) findViewById(ru.ryakovlev.jellypairs.R.id.star_1);
		mStar2 = (ImageView) findViewById(ru.ryakovlev.jellypairs.R.id.star_2);
		mStar3 = (ImageView) findViewById(ru.ryakovlev.jellypairs.R.id.star_3);
		mBackButton = (ImageView) findViewById(ru.ryakovlev.jellypairs.R.id.button_back);
		mNextButton = (ImageView) findViewById(ru.ryakovlev.jellypairs.R.id.button_next);
