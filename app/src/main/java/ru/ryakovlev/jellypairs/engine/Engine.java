package ru.ryakovlev.jellypairs.engine;
...
import ru.ryakovlev.jellypairs.events.EventObserverAdapter;
	...
	public void onEvent(ThemeSelectedEvent event) {
		...
		AsyncTask<Void, Void, TransitionDrawable> task = new AsyncTask<Void, Void, TransitionDrawable>() {
			...
			protected TransitionDrawable doInBackground(Void... params) {
				...
				backgrounds[1] = mSelectedTheme.backgroundImage.isEmpty() ? defaultBackground : Shared.config.createDrawable(Shared.context, mSelectedTheme.backgroundImage);
