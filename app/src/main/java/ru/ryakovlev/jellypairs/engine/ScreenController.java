...
import ru.ryakovlev.jellypairs.fragments.DifficultySelectFragment;
import ru.ryakovlev.jellypairs.fragments.GameFragment;
import ru.ryakovlev.jellypairs.fragments.MenuFragment;
import ru.ryakovlev.jellypairs.fragments.ThemeSelectFragment;
...
public class ScreenController {
	...
	public void openScreen(Screen screen) {
		...
		fragmentTransaction.replace(ru.ryakovlev.jellypairs.R.id.fragment_container, fragment);
